  ...
  const problems = [
    {
      ...
      title: "Wireless stores are leaking profit every day",
      description: "Hidden costs and missed opportunities drain your bottom line without you even knowing it."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Repairs sit unpicked up. Inventory dies on shelves",
      description: "Poor tracking leads to abandoned repairs and dead stock eating into your profits."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "You can't manage what you can't measure. Employee productivity remains a mystery."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "No real profit tracking",
      description: "Revenue isn't profit. Without proper COGS tracking, you're flying blind on actual margins."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Juggling multiple tools creates data silos, inefficiencies, and costly mistakes."
    }
  ];
