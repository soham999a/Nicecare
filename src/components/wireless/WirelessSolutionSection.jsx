  ...
  const solutions = [
    {
      ...
      title: "Sales + Repairs",
      description: "Unified system for both sales transactions and repair tracking with seamless workflow integration."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Track every device by serial number, IMEI, and condition for complete inventory visibility."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Complete carrier unlock tracking with pricing, margins, and automated customer notifications."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Trade-Ins",
      description: "Streamlined trade-in process with instant valuations, condition assessment, and profit tracking."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Warranty Engine",
      description: "Automated warranty tracking, upsell opportunities, and margin optimization for maximum profit."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Built-in customer loyalty system with points, rewards, and automated retention campaigns."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Intelligent review routing - happy customers to Google, unhappy ones to private feedback."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Comprehensive employee performance tracking with revenue, efficiency, and accountability metrics."
    }
  ];
