  ...
  return (
    <main className="p-4 md:p-6 lg:p-8 space-y-6 animate-fade-in">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md p-6 border border-slate-200 dark:border-gray-700 transform transition-all scale-100">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Remove Employee?</h3>
              <p className="text-slate-500 dark:text-gray-400 mb-6">
                Are you sure you want to remove "{deleteConfirm?.name}"? This will deactivate their account.
              </p>
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-[1.9rem] font-bold tracking-tight text-slate-900 dark:text-gray-50">Employee Management</h1>
